...
subjectPhenotype <- "~/Desktop/GTEx_Data_V6_Annotations_SubjectPhenotypesDS.txt"
sampleAttributes <- "~/Desktop/GTEx_Data_V6_Annotations_SampleAttributesDS.txt"
junctionQuant    <- "~/Desktop/GTEx/GTEx_junction_reads.txt"
