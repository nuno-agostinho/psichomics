...
be sure to select the **Load annotation from RDS file...** option, click the
button that appears below and select the recently created RDS file. Otherwise, 
if you are using the CLI version, perform the following steps:
