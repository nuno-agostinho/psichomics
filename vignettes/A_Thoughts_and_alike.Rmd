...
> TODO: Fix groups with only one row stupidly having a bad layout simply because
you're including a list in a row (for some reason, there's no problem if there
are 2 or more rows...)

> TODO: Allow to merge and remove groups