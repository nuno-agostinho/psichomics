...
Simply retrieve [VAST-TOOLS' alternative splicing annotation][vastAnnot] and 
give the path to the downloaded folder as input. Note that, however, complex 
events (i.e. alternative coordinates for the exon ends) are not yet parsable.
