...
importing generic data from any other source as long as the tables are prepared
as detailed below depeding on the dataset.
...
> Sample information retrieved from SRA Run Selector can be automatically
loaded into psichomics using [`loadLocalFiles()`][loadLocalFiles]
...
`10_18748_21822`, `chromosome 10 (18748 to 21822)` and `chr10:18748-21822`
- Optionally, indicate the strand with `+` or `-` at the end of the junction
identifier; e.g. `10:3213:9402:+` and `chr10:3213-9402 -`
...
> Note that there is currently no way to parse alternative splicing events (e.g.
