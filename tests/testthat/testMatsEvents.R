...
test_that("parseMatsEvent parses alt. 3' splice site events", {
    ...
    expect_equal(parsed[1, "C2.start"], 79685787)
    expect_equal(parsed[1, "A1.start"], 79685796)
    expect_equal(parsed[1, "C2.end"],  79685910)
    ...
    expect_equal(parsed[2, "C2.start"], 57000179)
    expect_equal(parsed[2, "A1.start"], 57000096)
    expect_equal(parsed[2, "C2.end"],   57000030)
...
test_that("parseMatsEvent parses alt. 3' splice site event annotation", {
    ...
    expect_equal(parsed$C2.start, 57000179)
    expect_equal(parsed$A1.start, 57000096)
...
test_that("parseMatsEvent parses alt. 5' splice events", {
    ...
    # Plus strand
    expect_equal(parsed[1, "Strand"], "+")
    expect_equal(parsed[1, "C1.start"], 102884421)
    expect_equal(parsed[1, "C1.end"], 102884501)
    expect_equal(parsed[1, "A1.end"], 102884489)
    ...
    # Minus strand
    expect_equal(parsed[2, "Strand"], "-")
    expect_equal(parsed[2, "C1.start"], 38285953)
    expect_equal(parsed[2, "C1.end"], 38285863)
    expect_equal(parsed[2, "A1.end"], 38285869)
...
test_that("parseMatsEvent parses alt. 5' splice event annotation", {
    ...
    expect_equal(parsed$C1.end,   38285863)
    expect_equal(parsed$A1.end,   38285869)
...
test_that("parseMatsEvent parses alt. first exon event annotation", {
    ...
    # Plus strand
    expect_equal(parsed[1, "Strand"], "+")
    expect_equal(parsed[1, "C1.start"], 16308723)
    expect_equal(parsed[1, "C1.end"],   16308879)
    expect_equal(parsed[1, "A1.start"], 16308967)
    expect_equal(parsed[1, "A1.end"],   16309119)
    ...
    # Minus strand
    expect_equal(parsed[2, "Strand"], "-")
    expect_equal(parsed[2, "C1.start"], 31839483)
    expect_equal(parsed[2, "C1.end"],   31839356)
    expect_equal(parsed[2, "A1.start"], 31822194)
    expect_equal(parsed[2, "A1.end"],   31822086)
...
test_that("parseMatsEvent parses alt. last exon event annotation", {
    ...
    expect_equal(parsed[1, "A1.start"], 111858645)
    expect_equal(parsed[1, "A1.end"],   111858828)
    expect_equal(parsed[1, "C2.start"], 111851063)
    expect_equal(parsed[1, "C2.end"],   111851921)
    expect_null(parsed[1, "P.value"])
    expect_null(parsed[1, "FDR"])
    expect_null(parsed[1, "Inclusion.level.A"])
    expect_null(parsed[1, "Inclusion.level.B"])
    ...
    expect_equal(parsed[2, "A1.start"], 93771027)
    expect_equal(parsed[2, "A1.end"],   93770667)
    expect_equal(parsed[2, "C2.start"], 93777165)
    expect_equal(parsed[2, "C2.end"],   93776725)
    expect_null(parsed[2, "P.value"])
    expect_null(parsed[2, "FDR"])
    expect_null(parsed[2, "Inclusion.level.A"])
    expect_null(parsed[2, "Inclusion.level.B"])
...
test_that("parseMatsA3SS parses an alt. 3' splice site event's junctions", {
    ...
    expect_equal(parsed$C2.start, 79685787)
    expect_equal(parsed$A1.start, 79685796)
...
test_that("parseMatsA3SS parses an alt. 5' splice site event's junctions", {
    ...
    expect_equal(parsed$C1.end,   102884501)
    expect_equal(parsed$A1.end,   102884489)
...
test_that("parseMatsALE parses an alt. last exon event's junctions", {
    ...
    parsed <- parseMatsAFE(junctions, strand = "+")
    expect_equal(parsed$C1.start, 111858645)
    expect_equal(parsed$C1.end,   111858828)
    expect_equal(parsed$A1.start, 111851063)
    expect_equal(parsed$A1.end,   111851921)
    expect_equal(parsed$C2.start, 111850441)
    expect_equal(parsed$C2.end,   111850543)
})