...
![Splicing event types](https://bitbucket-assetroot.s3.amazonaws.com/repository/4gEBMd/2185438774-Slide1.jpg?Signature=Xm%2BJUUkZqW3lYXqpecgLsZIbr4A%3D&Expires=1451355558&AWSAccessKeyId=0EMWEFSGA12Z1HF1TZ82)
...
types <- c("SE", "AFE", "ALE", "MXE", "A3SS", "A5SS", "RI")
...
--------------|--------|----------|---------
List of lists | 63.3 s | 30.4  MB | 3e702152
Data frame    |  0.4 s | 26.2  MB | 4f596587

Doing the same thing for SUPPA events:

Type          | Time   | Memory   | Commit
--------------|--------|----------|---------
List of lists | 20.5 s | 42.75 MB | 3e702152
Data frame    |  2.2 s | 40.2  MB | 
