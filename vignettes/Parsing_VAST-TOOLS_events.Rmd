...
without the C2 start, although this isn't present in the VAST-TOOLS annotation.
So, the C2 end may be or not be present.

Also... the alternative exon end may be missing instead, like in this case:
