...
junctionQuant <- readRDS("BRCA_psi.RDS")
```
...
folder <- "~/Downloads/Breast invasive carcinoma 2016-01-28/"
...
```{r prepare to quantify splicing}
...
match <- getPatientFromSample(samples, clinical, rmNoMatches=FALSE)
