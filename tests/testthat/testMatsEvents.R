...
test_that("parseMatsEvent parses alt. 3' splice site event (+ strand)", {
    event <- c(ID = "3658", GeneID = "ENSG00000067715", geneSymbol = "SYT1", 
...
test_that("parseMatsEvent parses alt. 3' splice site event (- strand)", {
    event <- c(ID = "1234", GeneID = "ENSG00000076108", geneSymbol = "BAZ2A", 
...
test_that("parseMatsEvent parses alt. 5' splice event (+ strand)", {
    event <- c(ID = "1366", GeneID = "ENSG00000172465", geneSymbol = "TCEAL1", 
...
test_that("parseMatsEvent parses alt. 5' splice event (- strand)", {
    event <- c(ID = "4064", GeneID = "ENSG00000077782", geneSymbol = "FGFR1", 
...
test_that("parseMatsEvent parses skipping exon event (+ strand)", {
    event <- c(ID = "4626", GeneID = "ENSG00000151422", geneSymbol = "FER", 
...
test_that("parseMatsEvent parses skipping exon event (- strand)", {
    event <- c(ID = "16170", GeneID = "ENSG00000151914", geneSymbol = "DST",
...
test_that("parseMatsEvent parses intron retention event (+ strand)", {
    event <- c(ID = "2287", GeneID = "ENSG00000011295", geneSymbol = "TTC19",
...
test_that("parseMatsEvent parses intron retention event (- strand)", {
    event <- c(ID = "1324", GeneID = "ENSG00000121851", geneSymbol = "POLR3GL", 
...
test_that("parseMatsEvent parses mutually exc. exons event (+ strand)", {
    event <- c(ID = "217", GeneID = "ENSG00000120251", geneSymbol = "GRIA2", 
...
test_that("parseMatsEvent parses mutually exc. exons event (- strand)", {
    event <- c(ID = "1388", GeneID = "ENSG00000138468", geneSymbol = "SENP7", 
...
test_that("parseMatsEvent parses alt. first exon event annotation (+ strand)", {
    event <- c(ID = "54", GeneID = "ENSG00000072958", geneSymbol = "AP1M1",
               chr = "chr19", strand = "+",
...
test_that("parseMatsEvent parses alt. first exon event annotation (- strand)", {
    event <- c(ID = "1", GeneID = "ENSG00000007372", geneSymbol = "PAX6",
               chr = "chr11", strand = "-",
...
test_that("parseMatsEvent parses alt. last exon event annotation (+ strand)", {
    event <- c(ID = "14", GeneID = "ENSG00000153093", geneSymbol = "ACOXL",
               chr = "chr2", strand = "+",
...
test_that("parseMatsEvent parses alt. last exon event annotation (- strand)", {
    event <- c(ID = "32", GeneID = "ENSG00000223745",
...
test_that("parseMultipleMatsEvents parses multiple MATS alt. splicing events", {
    ...
    ")
    parsed <- parseMultipleMatsEvents(events, event_type="SE")
    expect_equal(parsed[[1]]$`C1 start`, 93467826)
    expect_equal(parsed[[1]]$`C1 end`,   93467790)
    expect_equal(parsed[[2]]$`C2 start`, 93466585)
    expect_equal(parsed[[2]]$`C1 end`,   93467790)
    expect_equal(parsed[[3]]$`A1 start`, 93466585)
    expect_equal(parsed[[3]]$`C1 end`,   93467790)
})