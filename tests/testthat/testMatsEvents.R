...
test_that("parseMatsEvent parses alt. 3' splice site events", {
    ...
    expect_equivalent(parsed[1, "C2.start"], list(c(79685787, 79685796)))
    ...
    expect_equivalent(parsed[2, "C2.start"], list(c(57000179, 57000096)))
...
test_that("parseMatsEvent parses alt. 3' splice site event annotation", {
    ...
    expect_equivalent(parsed$C2.start, list(c(57000179, 57000096)))
...
test_that("parseMatsEvent parses alt. 5' splice events", {
    ...
    expect_equivalent(parsed[1, "C1.end"], list(c(102884501, 102884489)))
    ...
    expect_equivalent(parsed[2, "C1.end"], list(c(38285863, 38285869)))
...
test_that("parseMatsEvent parses alt. 5' splice event annotation", {
    ...
    expect_equivalent(parsed$C1.end, list(c(38285863, 38285869)))
...
test_that("parseMatsA3SS parses an alt. 3' splice site event's junctions", {
    ...
    expect_equivalent(parsed$C2.start, list(c(79685787, 79685796)))
...
test_that("parseMatsA3SS parses an alt. 5' splice site event's junctions", {
    ...
    expect_equivalent(parsed$C1.end, list(c(102884501, 102884489)))
