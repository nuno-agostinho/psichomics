...
# Loading data from VAST-TOOLS

psichomics supports loading inclusion levels and gene expression tables from
VAST-TOOLS (the tables available after running `vast-tools combine`). To load
those files, move them into a new folder. If you have sample and/or subject 
